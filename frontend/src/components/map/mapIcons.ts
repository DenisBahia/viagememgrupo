...
// Blue "dot with halo" marker used to represent the user's current device location,
// similar to Google's own "My Location" indicator.
export function buildCurrentLocationIcon(): google.maps.Icon {
  const svg = `
